    ...
    protected render() {
        return html` <post-head-image
            ...
            <post-body>
                ...
                <p>
                    1부에서는 책을 쓰면서 겪는 과정을 이야기했다면, 2부에서는
                    책을 쓸 때에 도움이 되는 내용들을 되돌아보며 이야기를
                    써보려고 합니다.
                </p>
                ...
                <p>
                    ...
                    바뀌게 됩니다. 그래서 후에 목차 번호를 변경하게 되면 앞 뒤로
                    숫자들을 일일이 변경해 주어야 합니다. 예로 1부터 17장을
                    작성하였는데 중간에 2장을 새로 추가하면 기존 2부터 17까지
                    작성한 목차를 수정하여야 합니다. 그래서 번호를 미리 써두지
                ...
                <p>
                    ...
                    볼 수 있는데요. 이는 책에서는 필수적인 요소로 그림마다
                    작성해 주어야 합니다. 목차와 마찬가지로 이 또한 중간에
                ...
                <p>
                    ...
                    작성을 끝내고 후에 작업을 하게 되었는데 놓치는 부분이 있을
                ...
                <p>
                    ...
                    1차 원고를 제출하게 됩니다. 정말 소스코드를 고치게 되어
                    수정이 이루어지면 작업량이 5배는 되는 느낌입니다. 하지만
                    마감은 사람을 하게 만들었고, 원고를 제출하게
                ...
                <p>
                    ...
                    및 내용 확인 등의 많은 것들을 해줍니다. 교정이 된 책을 보면,
                    책의 모습을 갖추게 되면서 이게 내가 쓴 게 맞나 할 정도로
                    놀랍게 바뀌게 됩니다. 말투가 교정이 되고, 전문성이 보이게
                    되고, 디자인이 추가되는 신기한 경험이었습니다. 교정은
                ...
                <p>
                    ...
                    했고, 책을 전달하고 7일간의 리뷰 기간을 주게 되었습니다.
                    기술책을 7일 만에 보는 것이 가능할까라는 의문이 들었고,
                    지인이 리뷰를 해주었는데 코드를 따라 치지는 못하고 내용을
                    보는 데에는 열심히 하면 7일이라는 기간 내에 가능했습니다.
                    책에 대한 리뷰는 내 책을 읽어주었구나 라는 느낌이 들 정도로
                    잘 작성해 주셨습니다. 피드백은 교정이 이루어진 덕분에 많은
                ...
                <p>
                    ...
                    수정과는 많이 다릅니다. 이전에는 텍스트를 사용하여 수정하여
                    전달했다면, 이제는 pdf로 만들어진 교정본에 메모를 남기는
                    방식으로 수정을 하여야 합니다. 이로 인해서 대규모의 수정은
                    어려워지고 이미지를 수정하는 식의 수정이 이루어지게 되어
                ...
                <p>
                    ...
                    수정사항을 마무리하여 제가 할 일은 끝이 났습니다. 교정이
                    되면서 말투가 달라지고 책을 직접적으로 수정할 수 없게 되면서
                ...
                <p>
                    ...
                    있는 것이 신기했습니다. 지금 책을 보면 내가 이걸 어떻게
                    했지...라는 생각만 듭니다. 과거의 내가 했겠지라는
                    생각뿐입니다. 다시 책을 쓰게 된다면 이전보다 잘 쓸 수
