...
// .yarn/cache/@webcomponents-webcomponentsjs-npm-2.6.0-e6217c8695-b1325d7ce2.zip/node_modules/@webcomponents/webcomponentsjs/webcomponents-bundle.js
var require_webcomponents_bundle = __commonJS({
  ".yarn/cache/@webcomponents-webcomponentsjs-npm-2.6.0-e6217c8695-b1325d7ce2.zip/node_modules/@webcomponents/webcomponentsjs/webcomponents-bundle.js"(exports) {
    (function() {
      "use strict";
      var v;
      function ba(a) {
      ...
      function ia(a, b) {
        if (b)
          a: {
            ...
            d = c[a];
            b = b(d);
            b != d && b != null && ca(c, a, { configurable: true, writable: true, value: b });
          }
      }
      ...
      ia("Symbol.iterator", function(a) {
        ...
        for (var b = "Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array".split(" "), c = 0; c < b.length; c++) {
          var d = ea[b[c]];
          typeof d === "function" && typeof d.prototype[a] != "function" && ca(d.prototype, a, { configurable: true, writable: true, value: function() {
            return ja(ba(this));
          } });
        }
        return a;
      ...
      function Ja(a, b) {
        for (; a.N === 3; )
          a = a.I;
        a.N === 0 ? a.ba.push(b) : (a.Ea = true, Ka(function() {
          var c = a.N === 1 ? b.bb : b.cb;
          if (c === null)
            (a.N === 1 ? La : Ma)(b.promise, a.I);
          else {
            try {
              var d = c(a.I);
            } catch (e) {
      ...
      function Na(a) {
        a.N === 2 && a.ba.length === 0 && Ka(function() {
          a.Ea || typeof console !== "undefined" && console && console.warn("Possible Unhandled Promise Rejection:", a.I);
        });
      ...
      function Oa(a, b, c) {
        this.bb = typeof a === "function" ? a : null;
        this.cb = typeof b === "function" ? b : null;
        this.promise = c;
      }
      function Ia(a, b) {
        var c = false;
      ...
      function Qa(a) {
        return a && typeof a === "object" && a.constructor === A ? a : new A(function(b) {
          b(a);
        });
      }
      function Ra(a) {
      ...
      if (!window.Promise) {
        ...
        A.resolve = Qa;
        A.reject = Ra;
        var Ta = document.createTextNode(""), Va = [];
      ...
      (function(a, b) {
        if (!(b in a)) {
          var c = typeof global === typeof c ? window : global, d = 0, e = String(Math.random()), f = "__symbol@@" + e, g = a.getOwnPropertyNames, h = a.getOwnPropertyDescriptor, k = a.create, l = a.keys, m = a.freeze || a, q = a.defineProperty, H = a.defineProperties, C = h(a, "getOwnPropertyNames"), t = a.prototype, F = t.hasOwnProperty, E = t.propertyIsEnumerable, M = t.toString, y = function(I, u, G) {
            ...
            q(t, I, { enumerable: false, configurable: true, get: w, set: function(u) {
              wa(this, I, { enumerable: false, configurable: true, writable: true, value: u });
              y(this, I, true);
            } });
          ...
          }, fa = k(null), gc = { value: J }, fb = function(u) {
            return fa[u];
          }, Ua = function(u, G, p) {
            var r = String(G);
            if (ha(r)) {
          ...
          C.value = function(u) {
            ...
            if (F.call(fa, u) && (u = u.slice(10), u.slice(0, 10) === "__symbol:" && (u = u.slice(10), u !== e)))
          ...
          C.value = function() {
            var u = M.call(this);
            return u === "[object String]" && ha(this) ? "[object Symbol]" : u;
          };
          q(t, "toString", C);
          try {
            if (k(q({}, "__symbol:", { get: function() {
      ...
      (function(a, b) {
        ...
        "iterator match replace search split hasInstance isConcatSpreadable unscopables species toPrimitive toStringTag".split(" ").forEach(function(g) {
          g in b || (c(b, g, { value: b(g) }), g === "toStringTag" && (f = a.getOwnPropertyDescriptor(d, "toString"), f.value = function() {
            var h = e.call(this), k = this == null ? this : this[b.toStringTag];
      ...
      Object.prototype.toString = function() {
        return this === void 0 ? "[object Undefined]" : this === null ? "[object Null]" : Wa.call(this);
      };
      ...
      Map.prototype[Symbol.iterator] || (Map.prototype[Symbol.iterator] = function Za() {
        ...
        return Ea(Za, function(e) {
          e.g == 1 && (b = [], c.forEach(function(f, g) {
            b.push([g, f]);
          }), d = 0);
          if (e.g != 3)
            return d < b.length ? e = ya(e, b[d]) : (e.g = 0, e = void 0), e;
      ...
      if (!window.Event || bb && typeof window.Event !== "function") {
        var cb = window.Event;
      ...
      if (!window.CustomEvent || bb && typeof window.CustomEvent !== "function")
      ...
      if (!window.MouseEvent || bb && typeof window.MouseEvent !== "function") {
      ...
      var ib, jb, kb = Element.prototype, nb = (ib = Object.getOwnPropertyDescriptor(kb, "attributes")) !== null && ib !== void 0 ? ib : Object.getOwnPropertyDescriptor(Node.prototype, "attributes"), ob = (jb = nb === null || nb === void 0 ? void 0 : nb.get) !== null && jb !== void 0 ? jb : function() {
      ...
      var qb, rb = Element.prototype;
      rb.hasOwnProperty("matches") || (rb.matches = (qb = rb.webkitMatchesSelector) !== null && qb !== void 0 ? qb : rb.msMatchesSelector);
      ...
      function tb(a) {
        ...
        a.hasOwnProperty("append") || Object.defineProperty(a, "append", { configurable: true, enumerable: true, writable: true, value: function(b) {
          ...
          for (d = c.next(); !d.done; d = c.next())
            d = d.value, sb.call(this, typeof d === "string" ? document.createTextNode(d) : d);
        } });
      }
      tb(Document);
      tb(DocumentFragment);
      tb(Element);
      var ub, vb, wb = Node.prototype.insertBefore, xb = (vb = (ub = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild")) === null || ub === void 0 ? void 0 : ub.get) !== null && vb !== void 0 ? vb : function() {
      ...
      function yb(a) {
        ...
        a.hasOwnProperty("prepend") || Object.defineProperty(a, "prepend", { configurable: true, enumerable: true, writable: true, value: function(b) {
          ...
          for (var e = c.next(); !e.done; e = c.next())
            e = e.value, wb.call(this, typeof e === "string" ? document.createTextNode(e) : e, d);
        } });
      }
      yb(Document);
      yb(DocumentFragment);
      yb(Element);
      var zb, Ab, Bb = Node.prototype.appendChild, Cb = Node.prototype.removeChild, Db = (Ab = (zb = Object.getOwnPropertyDescriptor(Node.prototype, "firstChild")) === null || zb === void 0 ? void 0 : zb.get) !== null && Ab !== void 0 ? Ab : function() {
        return this.firstChild;
      };
      function Eb(a) {
        a = a.prototype;
        a.hasOwnProperty("replaceChildren") || Object.defineProperty(a, "replaceChildren", { configurable: true, enumerable: true, writable: true, value: function(b) {
          for (var c = [], d = 0; d < arguments.length; ++d)
            c[d] = arguments[d];
          for (; (d = Db.call(this)) !== null; )
            Cb.call(this, d);
          c = ka(c);
          for (d = c.next(); !d.done; d = c.next())
            d = d.value, Bb.call(this, typeof d === "string" ? document.createTextNode(d) : d);
        } });
      }
      Eb(Document);
      Eb(DocumentFragment);
      Eb(Element);
      var Fb, Gb, Hb, Ib, Jb = Node.prototype.insertBefore, Kb = (Gb = (Fb = Object.getOwnPropertyDescriptor(Node.prototype, "parentNode")) === null || Fb === void 0 ? void 0 : Fb.get) !== null && Gb !== void 0 ? Gb : function() {
        return this.parentNode;
      }, Lb = (Ib = (Hb = Object.getOwnPropertyDescriptor(Node.prototype, "nextSibling")) === null || Hb === void 0 ? void 0 : Hb.get) !== null && Ib !== void 0 ? Ib : function() {
        ...
        a.hasOwnProperty("after") || Object.defineProperty(a, "after", { configurable: true, enumerable: true, writable: true, value: function(b) {
          ...
          if (d !== null) {
            ...
            for (var f = c.next(); !f.done; f = c.next())
              f = f.value, Jb.call(d, typeof f === "string" ? document.createTextNode(f) : f, e);
          }
        } });
      }
      Mb(CharacterData);
      Mb(Element);
      var Nb, Ob, Pb = Node.prototype.insertBefore, Qb = (Ob = (Nb = Object.getOwnPropertyDescriptor(Node.prototype, "parentNode")) === null || Nb === void 0 ? void 0 : Nb.get) !== null && Ob !== void 0 ? Ob : function() {
        return this.parentNode;
      };
      function Rb(a) {
        a = a.prototype;
        a.hasOwnProperty("before") || Object.defineProperty(a, "before", { configurable: true, enumerable: true, writable: true, value: function(b) {
          ...
          if (d !== null) {
            c = ka(c);
            for (var e = c.next(); !e.done; e = c.next())
              e = e.value, Pb.call(d, typeof e === "string" ? document.createTextNode(e) : e, this);
          }
        } });
      }
      Rb(CharacterData);
      Rb(Element);
      var Sb, Tb, Ub = Node.prototype.removeChild, Vb = (Tb = (Sb = Object.getOwnPropertyDescriptor(Node.prototype, "parentNode")) === null || Sb === void 0 ? void 0 : Sb.get) !== null && Tb !== void 0 ? Tb : function() {
        return this.parentNode;
      };
      function Wb(a) {
        a = a.prototype;
      ...
      Wb(CharacterData);
      Wb(Element);
      var Xb, Yb, Zb = Node.prototype.insertBefore, $b = Node.prototype.removeChild, ac = (Yb = (Xb = Object.getOwnPropertyDescriptor(Node.prototype, "parentNode")) === null || Xb === void 0 ? void 0 : Xb.get) !== null && Yb !== void 0 ? Yb : function() {
        return this.parentNode;
      };
      function bc(a) {
        a = a.prototype;
        a.hasOwnProperty("replaceWith") || Object.defineProperty(a, "replaceWith", { configurable: true, enumerable: true, writable: true, value: function(b) {
          ...
          if (d !== null) {
            c = ka(c);
            for (var e = c.next(); !e.done; e = c.next())
              e = e.value, Zb.call(d, typeof e === "string" ? document.createTextNode(e) : e, this);
            $b.call(d, this);
          }
        } });
      }
      bc(CharacterData);
      bc(Element);
      var cc = window.Element.prototype, dc = window.HTMLElement.prototype, ec = window.SVGElement.prototype;
      ...
      var jc = document.querySelector('script[src*="webcomponents-bundle"]'), kc = /wc-(.+)/, lc = {};
      if (!lc.noOpts) {
        location.search.slice(1).split("&").forEach(function(a) {
          a = a.split("=");
          var b;
          a[0] && (b = a[0].match(kc)) && (lc[b[1]] = a[1] || true);
        });
        if (jc)
          for (var mc = 0, nc = void 0; nc = jc.attributes[mc]; mc++)
            nc.name !== "src" && (lc[nc.name] = nc.value || true);
        var oc = {};
      ...
      if (pc) {
        ...
        var qc = lc.noPatch;
        ic.ShadyDOM.noPatch = qc === "true" ? true : qc;
      }
      ...
      (function() {
        ...
        var c = typeof HTMLTemplateElement === "undefined", d = !(document.createDocumentFragment().cloneNode() instanceof DocumentFragment), e = false;
        /Trident/.test(navigator.userAgent) && function() {
          function p(z, R) {
            if (z instanceof DocumentFragment)
              for (var lb; lb = z.firstChild; )
                B.call(this, lb, R);
            else
              B.call(this, z, R);
            return z;
          ...
          var aa = Node.prototype.removeChild, la = Node.prototype.replaceChild;
        ...
        } }, t = Element.prototype.querySelectorAll, F = Document.prototype.querySelectorAll, E = DocumentFragment.prototype.querySelectorAll, M = function() {
          if (!c) {
        ...
        if (c) {
          var y = document.implementation.createHTMLDocument("template"), W = true, w = document.createElement("style");
          ...
          var Ua = w("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")), gb = w("style script xmp iframe noembed noframes plaintext noscript".split(" ")), wa = function(p, r) {
          ...
          var I = function(p, r) {
            if (r.querySelectorAll && (r = b(r, "template"), r.length !== 0)) {
              ...
              for (var B = 0, K = p.length, aa, la; B < K; B++)
                la = r[B], aa = p[B], a && a.Z && a.Z(la), m.call(aa.parentNode, u.call(la, true), aa);
            }
            ...
            if (!e && d && this instanceof DocumentFragment)
              ...
              this.nodeType === Node.ELEMENT_NODE && this.localName === "template" && this.namespaceURI == document.documentElement.namespaceURI ? r = a.sa(this, p) : r = f.call(this, p);
            p && I(r, this);
            return r;
          }, G = Document.prototype.importNode = function(p, r) {
            r = r || false;
            if (p.localName === "template")
              return a.sa(p, r);
      ...
      function vc(a) {
        return (a = L(a)) && a.firstChild !== void 0;
      }
      function O(a) {
      ...
      var yc = Element.prototype, zc = yc.matches || yc.matchesSelector || yc.mozMatchesSelector || yc.msMatchesSelector || yc.oMatchesSelector || yc.webkitMatchesSelector, Ac = document.createTextNode(""), Bc = 0, Cc = [];
      new MutationObserver(function() {
        for (; Cc.length; )
          try {
            Cc.shift()();
      ...
      function Vc(a, b) {
        ...
        c.ea.oa.add(b);
        var d = c.ea;
        return { Ra: b, X: d, Sa: a, takeRecords: function() {
      ...
      var bd = ad("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")), cd = ad("style script xmp iframe noembed noframes plaintext noscript".split(" "));
      function dd(a, b) {
      ...
      ;
      var ed = N.H, fd = { querySelector: function(a) {
      ...
      var jd = document.createTreeWalker(document, NodeFilter.SHOW_ALL, null, false), kd = document.createTreeWalker(document, NodeFilter.SHOW_ELEMENT, null, false), ld = document.implementation.createHTMLDocument("inert");
      function md(a) {
        for (var b; b = a.__shady_native_firstChild; )
          a.__shady_native_removeChild(b);
      }
      var nd = ["firstElementChild", "lastElementChild", "children", "childElementCount"], od = ["querySelector", "querySelectorAll", "append", "prepend", "replaceChildren"];
      function pd() {
        var a = ["dispatchEvent", "addEventListener", "removeEventListener"];
        window.EventTarget ? (S(window.EventTarget.prototype, a), window.__shady_native_addEventListener === void 0 && S(Window.prototype, a)) : (S(Node.prototype, a), S(Window.prototype, a));
        ed ? S(Node.prototype, "parentNode firstChild lastChild previousSibling nextSibling childNodes parentElement textContent".split(" ")) : id(Node.prototype, { parentNode: { get: function() {
          jd.currentNode = this;
        ...
        ed ? (S(Element.prototype, nd), S(Element.prototype, [
          "previousElementSibling",
          "nextElementSibling",
          "innerHTML",
          "className"
        ]), S(HTMLElement.prototype, ["children", "innerHTML", "className"])) : (id(Element.prototype, a), id(Element.prototype, { previousElementSibling: { get: function() {
          kd.currentNode = this;
      ...
      td(rd);
      td(sd);
      var ud = N.H || N.J === true, vd = ud ? function() {
      } : function(a) {
        var b = D(a);
        b.Pa || (b.Pa = true, Lc(a, sd));
      }, wd = ud ? function() {
      } : function(a) {
        var b = D(a);
        b.Oa || (b.Oa = true, Lc(a, qd), window.customElements && window.customElements.polyfillWrapFlushCallback && !N.J || Lc(a, rd));
      };
      var xd = "__eventWrappers" + Date.now(), yd = function() {
      ...
      var Bd = {
        ...
        DOMFocusOut: true,
        keypress: true
      }, Cd = { DOMAttrModified: true, DOMAttributeNameChanged: true, DOMCharacterDataModified: true, DOMElementNameChanged: true, DOMNodeInserted: true, DOMNodeInsertedIntoDocument: true, DOMNodeRemoved: true, DOMNodeRemovedFromDocument: true, DOMSubtreeModified: true };
      function Dd(a) {
      ...
      function Fd(a) {
        a.__composedPath || (a.__composedPath = Ed(a.target, true));
      ...
      function Gd(a, b) {
        ...
        for (var c = 0, d, e = void 0, f, g = void 0; c < b.length; c++)
          if (d = b[c], f = Dd(d), f !== e && (g = a.indexOf(f), e = f), !O(f) || -1 < g)
            return d;
      }
      function Hd(a) {
        function b(c, d) {
      ...
      function Ld(a) {
        var b = a.composedPath(), c = b.map(function(k) {
          return Gd(k, b);
        }), d = a.bubbles;
        ...
        for (f = 0; f < b.length; f++) {
          ...
          var h = g === c[f];
          if (h || d) {
            if (e = h ? Event.AT_TARGET : Event.BUBBLING_PHASE, Kd(a, g, "bubble"), a.ra)
              return;
          }
        }
        e = 0;
      ...
      function Pd(a, b, c) {
        var d = Ad(c), e = d.capture, f = d.once, g = d.passive, h = d.La;
        d = d.Ja;
        if (b) {
          var k = typeof b;
            ...
            if (k !== "object" || b.handleEvent && typeof b.handleEvent === "function") {
              ...
              h = function(m) {
                ...
                if (l !== this) {
                  ...
                  Object.defineProperty(m, "currentTarget", { get: function() {
                    return l;
                  }, configurable: true });
                ...
                if (!O(l) && l.localName !== "slot" || m.composedPath().indexOf(l) != -1) {
                  if (m.composed || -1 < m.composedPath().indexOf(l)) {
                    if (Jd(m) && m.target === m.relatedTarget)
                      ...
                      var C = k === "function" ? b.call(l, m) : b.handleEvent && b.handleEvent(m);
      ...
      function Qd(a, b, c) {
        if (b) {
          var d = Ad(c);
          c = d.capture;
          var e = d.once, f = d.passive, g = d.La;
          d = d.Ja;
          if (Cd[a])
      ...
      var Sd = Q({ get composed() {
        this.__composed === void 0 && (yd ? this.__composed = this.type === "focusin" || this.type === "focusout" || yd(this) : this.isTrusted !== false && (this.__composed = Bd[this.type]));
        ...
        if (!this.__relatedTarget)
          return null;
        this.__relatedTargetComposedPath || (this.__relatedTargetComposedPath = Ed(this.__relatedTarget, true));
        ...
        this.ra = this.__immediatePropagationStopped = true;
      } });
      function Od(a, b) {
      ...
      var Td = Hd(Event), Ud = Hd(CustomEvent), Vd = Hd(MouseEvent);
      function Wd() {
      ...
      function ae(a, b, c, d) {
        ...
        d = b[k][g];
        for (a = []; 0 < k || 0 < g; )
          k == 0 ? (a.push(2), g--) : g == 0 ? (a.push(3), k--) : (h = b[k - 1][g - 1], l = b[k - 1][g], m = b[k][g - 1], q = l < m ? l < h ? l : h : m < h ? m : h, q == h ? (h == d ? a.push(0) : (a.push(1), d = h), k--, g--) : q == l ? (a.push(3), k--, d = l) : (a.push(2), g--, d = m));
        a.reverse();
        b = void 0;
        k = [];
      ...
      function fe(a, b, c) {
        var d = ee();
        return d && b === "class" ? (d.setElementClass(a, c), true) : false;
      }
      function ge(a, b) {
        var c = ee();
        c && c.unscopeNode(a, b);
      ...
      ;
      var ke = window.document, le = N.fa, me = Object.getOwnPropertyDescriptor(Node.prototype, "isConnected"), ne = me && me.get;
      function pe(a) {
      ...
      var ze = Q({
          ...
          switch (this.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
              if (!vc(this) && N.H) {
                ...
                pe(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.__shady_insertBefore(document.createTextNode(a));
              break;
            default:
              this.nodeValue = a;
          }
        ...
        insertBefore: function(a, b) {
          ...
          if (b === a)
            return a;
          se(this, a);
          var d = [], e = (c = te(this)) ? c.host.localName : ie(this), f = a.__shady_parentNode;
          if (f) {
            var g = ie(a);
            var h = !!c || !te(a) || le && this.__noInsertionPoint !== void 0;
            f.__shady_removeChild(a, h);
          }
          f = true;
          var k = (!le || a.__noInsertionPoint === void 0 && this.__noInsertionPoint === void 0) && !he(a, e), l = c && !a.__noInsertionPoint && (!le || a.nodeType === Node.DOCUMENT_FRAGMENT_NODE);
          if (l || k)
            k && (g = g || ie(a)), je(a, function(m) {
          ...
          vc(this) && (we(a, this, b), h = L(this), h.root ? (f = false, wc(this) && ve(h.root)) : c && this.localName === "slot" && (f = false, ve(c)));
        ...
        removeChild: function(a, b) {
          ...
          se(this, null, a);
          var c = te(a), d = c && xe(c, a), e = L(this);
          ...
          qe(a);
          c && ((b = this.localName === "slot") && (f = true), (d || b) && ve(c));
          f || (f = O(this) ? this.host : this, (!e.root && a.localName !== "slot" || f === a.__shady_native_parentNode) && f.__shady_native_removeChild(a));
          return a;
        },
        ...
        getRootNode: function(a) {
          if (this && this.nodeType) {
            var b = D(this), c = b.qa;
            c === void 0 && (O(this) ? (c = this, b.qa = c) : (c = (c = this.__shady_parentNode) ? c.__shady_getRootNode(a) : this, document.documentElement.__shady_native_contains(this) && (b.qa = c)));
            return c;
          }
        },
        contains: function(a) {
      ...
      var Ee = { get firstElementChild() {
        ...
        for (var b = [], c = 0; c < arguments.length; ++c)
          b[c] = arguments[c];
        for (; (c = this.__shady_firstChild) !== null; )
          this.__shady_removeChild(c);
        this.__shady_insertBefore(Oc.apply(null, x(b)), null);
      }, Ee)), Ge = Q({ querySelector: function(a) {
      ...
      var Ie = Q({ after: function(a) {
        ...
        for (var b = [], c = 0; c < arguments.length; ++c)
          b[c] = arguments[c];
        c = this.__shady_parentNode;
        c !== null && c.__shady_insertBefore(Oc.apply(null, x(b)), this);
      }, remove: function() {
        var a = this.__shady_parentNode;
      ...
      function Ke(a, b) {
        if (b === "slot")
          a = a.__shady_parentNode, wc(a) && ve(L(a).root);
        else if (a.localName === "slot" && b === "name" && (b = te(a))) {
          if (b.g) {
            Le(b);
            var c = a.Qa, d = Me(a);
            if (d !== c) {
      ...
      Mc(Oe, Te);
      var Ue = document.implementation.createHTMLDocument("inert"), Ve = Q({ get innerHTML() {
        return vc(this) ? dd(this.localName === "template" ? this.content : this, Jc) : this.__shady_native_innerHTML;
      }, set innerHTML(a) {
        if (this.localName === "template")
      ...
      var af = "__shady_native_" + uc(), bf = Q({ get activeElement() {
      ...
      var cf = window.document, df = Q({ importNode: function(a, b) {
        if (a.ownerDocument !== cf || a.localName === "template")
      ...
      ;
      var Se = {}, sf = N.deferConnectionCallbacks && document.readyState === "loading", tf;
      function uf(a) {
        var b = [];
        do
          b.unshift(a);
      ...
      Re.prototype._renderSelf = function() {
          ...
          for (b = 0; b < this.g.length; b++) {
            ...
            if (d = e.Ga) {
              for (f = 0; f < d.length; f++)
                L(d[f]).ua = null;
              e.Ga = null;
              d.length > e.assignedNodes.length && (e.xa = true);
            }
            e.xa && (e.xa = false, xf(this, c));
          }
          c = this.g;
          b = [];
        ...
        if (!N.preferPerformance && !this.Fa)
          for (b = this.host.__shady_firstChild; b; b = b.__shady_nextSibling)
            c = L(b), b.__shady_native_parentNode !== this.host || b.localName !== "slot" && c.assignedSlot || this.host.__shady_native_removeChild(b);
        this.Fa = true;
        sf = a;
        tf && tf();
      };
      function vf(a, b, c) {
        ...
        e !== d.assignedSlot && d.assignedSlot && (D(d.assignedSlot).xa = true);
      }
      function wf(a, b, c) {
      ...
      if (window.customElements && window.customElements.define && N.ya && !N.preferPerformance) {
        ...
        var zf = function(a, b, c) {
          ...
          if (b || c)
            a.prototype.connectedCallback = a.prototype.__shadydom_connectedCallback = function() {
              sf ? yf.set(this, true) : this[e] || (this[e] = true, b && b.call(this));
            }, a.prototype.disconnectedCallback = a.prototype.__shadydom_disconnectedCallback = function() {
              sf ? this.isConnected || yf.set(this, false) : this[e] && (this[e] = false, c && c.call(this));
            };
          return a;
        }, Af = window.customElements.define, Bf = function(a, b) {
        ...
        Object.defineProperty(window.CustomElementRegistry.prototype, "define", { value: Bf, configurable: true });
      }
      function te(a) {
      ...
      if (N.ya) {
        var Gf = N.H ? function(a) {
          ...
          wrap: N.J ? Ff : Gf,
          wrapIfNeeded: N.J === true ? Ff : function(a) {
            return a;
          },
          Wrapper: Cf,
          composedPath: Fd,
      ...
      ;
      function tg() {
        var a = !(ug === null || ug === void 0 || !ug.noDocumentConstructionObserver), b = !(ug === null || ug === void 0 || !ug.shadyDomFastWalk);
        this.ca = [];
        this.g = [];
        this.W = false;
      ...
      function Ag(a, b) {
        ...
        for (b = 0; b < c.length; b++) {
          var d = c[b];
          d.__CE_state === 1 ? a.connectedCallback(d) : Bg(a, d);
        }
      }
      function Cg(a, b) {
        var c = [];
      ...
      function Dg(a, b, c) {
        c = c === void 0 ? {} : c;
        var d = c.ob, e = c.upgrade || function(g) {
          return Bg(a, g);
        }, f = [];
        vg(a, b, function(g) {
          a.W && zg(a, g);
      ...
      function Gg(a, b, c, d) {
        ...
        if (e && (d === null || d === "http://www.w3.org/1999/xhtml") && (e = Eg(e, c)))
          try {
            var f = new e.constructorFunction();
            if (f.__CE_state === void 0 || f.__CE_definition === void 0)
            ...
            return Fg(g), b = d === null ? Hf.call(b, c) : If.call(b, d, c), Object.setPrototypeOf(b, HTMLUnknownElement.prototype), b.__CE_state = 2, b.__CE_definition = void 0, zg(a, b), b;
          }
        b = d === null ? Hf.call(b, c) : If.call(b, d, c);
        zg(a, b);
        return b;
      }
      function Fg(a) {
        var b = a.message, c = a.sourceURL || a.fileName || "", d = a.line || a.lineNumber || 0, e = a.column || a.columnNumber || 0, f = void 0;
        ErrorEvent.prototype.initErrorEvent === void 0 ? f = new ErrorEvent("error", { cancelable: true, message: b, filename: c, lineno: d, colno: e, error: a }) : (f = document.createEvent("ErrorEvent"), f.initErrorEvent("error", false, true, b, c, d), f.preventDefault = function() {
          Object.defineProperty(this, "defaultPrevented", { configurable: true, get: function() {
            return true;
          } });
        });
        f.error === void 0 && Object.defineProperty(f, "error", { configurable: true, enumerable: true, get: function() {
          return a;
        } });
      ...
      function Ig(a) {
        ...
        this.g = b;
        Dg(this.S, this.g);
        this.g.readyState === "loading" && (this.X = new MutationObserver(this.h.bind(this)), this.X.observe(this.g, { childList: true, subtree: true }));
      }
      function Jg(a) {
        a.X && a.X.disconnect();
      }
      Ig.prototype.h = function(a) {
        ...
        b !== "interactive" && b !== "complete" || Jg(this);
      ...
      v.eb = function(a, b) {
        ...
        this.ka.set(a, b);
        this.ma.push(a);
        this.V || (this.V = true, this.ja(function() {
          return Lg(c);
        }));
      };
      ...
      function Mg(a, b, c) {
        ...
        try {
          ...
          var f = function(m) {
            var q = e[m];
            if (q !== void 0 && !(q instanceof Function))
      ...
      function Lg(a) {
        if (a.V !== false) {
          ...
          for (var b = [], c = a.ma, d = new Map(), e = 0; e < c.length; e++)
            d.set(c[e], []);
          Dg(a.S, document, { upgrade: function(k) {
      ...
      function Ng(a, b, c) {
        ...
        c.prepend !== void 0 && (b.prepend = d(c.prepend));
        c.append !== void 0 && (b.append = d(c.append));
      }
      ;
      function Og(a) {
      ...
      function Pg(a) {
        ...
        fg !== void 0 && (c.before = b(fg));
        gg !== void 0 && (c.after = b(gg));
        hg !== void 0 && (c.replaceWith = function(d) {
      ...
      function Qg(a) {
        ...
        Vf && Vf.get ? b(Element.prototype, Vf) : kg && kg.get ? b(HTMLElement.prototype, kg) : xg(a, function(e) {
          b(e, { enumerable: true, configurable: true, get: function() {
            return Of.call(this, true).innerHTML;
          }, set: function(f) {
            var g = this.localName === "template", h = g ? this.content : this, k = If.call(document, this.namespaceURI, this.localName);
      ...
      function Tg(a) {
        ...
        Node.prototype.removeChild = function(c) {
          var d = c instanceof Element && T(c), e = Rf.call(this, c);
          d && Cg(a, c);
          return e;
        };
        Node.prototype.replaceChild = function(c, d) {
          if (c instanceof DocumentFragment) {
            ...
            c = Sf.call(this, c, d);
            if (T(this))
              for (Cg(a, d), d = 0; d < e.length; d++)
                Ag(a, e[d]);
            return c;
          }
          e = c instanceof Element && T(c);
          var f = Sf.call(this, c, d), g = T(this);
          g && Cg(a, d);
          e && Cg(a, c);
          g && Ag(a, c);
          return f;
        ...
        Tf && Tf.get ? b(Node.prototype, Tf) : wg(a, function(c) {
          b(c, { enumerable: true, configurable: true, get: function() {
            ...
            d != null && d !== "" && Pf.call(this, document.createTextNode(d));
          } });
        });
      }
      ;
      ...
      ug && !ug.forcePolyfill && typeof ug.define == "function" && typeof ug.get == "function" || Ug();
      ...
      function Wg(a) {
        var b = a = a.replace(Xg, "").replace(Yg, ""), c = new Vg();
        c.start = 0;
        c.end = b.length;
      ...
      function Zg(a, b) {
        ...
        a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = $g(c), c = c.replace(ah, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = c.indexOf("@") === 0, a.atRule ? c.indexOf("@media") === 0 ? a.type = bh : c.match(ch) && (a.type = dh, a.keyframesName = a.selector.split(ah).pop()) : a.type = c.indexOf("--") === 0 ? eh : fh);
        if (c = a.rules)
      ...
      function gh(a, b, c) {
        ...
        if (a.cssText || a.rules) {
          var e = a.rules, f;
          if (f = e)
            f = e[0], f = !(f && f.selector && f.selector.indexOf("--") === 0);
          if (f) {
            f = 0;
      ...
      var nh;
      window.ShadyCSS && window.ShadyCSS.cssBuild !== void 0 && (nh = window.ShadyCSS.cssBuild);
      var oh = !(!window.ShadyCSS || !window.ShadyCSS.disableRuntime);
      window.ShadyCSS && window.ShadyCSS.nativeCss !== void 0 ? lh = window.ShadyCSS.nativeCss : window.ShadyCSS ? (mh(window.ShadyCSS), window.ShadyCSS = void 0) : mh(window.WebComponents && window.WebComponents.flags);
      var X = lh;
      ...
      function Gh(a, b) {
        ...
        if (c === -1)
          return b(a, "", "", "");
        var d = Fh(a, c + 3), e = a.substring(c + 4, d);
        c = a.substring(0, c);
      ...
      function Mh(a) {
        a = a === void 0 ? "" : a;
        return a !== "" && X ? V ? a === "shadow" : a === "shady" : false;
      }
      ;
      function Nh() {
      }
      ...
      function Uh(a, b, c, d, e) {
        var f = Qh;
        e = e === void 0 ? "" : e;
        e === "" && (V || (d === void 0 ? "" : d) === "shady" ? e = wh(b, c) : (a = Jh(a), e = Vh(f, b, a.is, a.ha, c) + "\n\n"));
        return e.trim();
      }
      function Vh(a, b, c, d, e) {
        ...
        return wh(b, function(g) {
          g.i || (g.selector = g.F = Xh(a, g, a.h, c, f), g.i = true);
          e && e(g, c, f);
        });
      }
      function Wh(a, b) {
      ...
      function ei(a, b, c, d) {
        ...
        0 <= a.indexOf(":host") ? a = gi(a, d) : e !== 0 && (a = c ? hi(a, c) : a);
        c = false;
        0 <= e && (b = "", c = true);
        if (c) {
          var f = true;
      ...
      ea.Object.defineProperties(Nh.prototype, { g: { configurable: true, enumerable: true, get: function() {
        return "style-scope";
      } } });
      var Zh = /:(nth[-\w]+)\(([^)]+)\)/, di = /(^|[\s>+~]+)((?:\[.+?\]|[^\s>+~=[])+)/g, ki = /[[.:#*]/, ci = /^(::slotted)/, ji = /(:host)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, ii = /(?:::slotted)(?:\(((?:\([^)(]*\)|[^)(]*)+?)\))/, fi = /(.*):dir\((?:(ltr|rtl))\)(.*)/, ai = /:(?:matches|any|-(?:webkit|moz)-any)/, Qh = new Nh();
      ...
      function wi(a, b, c) {
        b && (b = 0 <= b.indexOf(";") ? xi(a, b, c) : Gh(b, function(d, e, f, g) {
          if (!e)
            return d + g;
          (e = wi(a, c[e], c)) && e !== "initial" ? e === "apply-shim-inherit" && (e = "inherit") : e = wi(a, c[f] || f, c) || f;
          return d + (e || "") + g;
        }));
        return b && b.trim() || "";
      }
      ...
      function zi(a, b, c, d) {
        ...
        if (b.D.P) {
          ...
          var g = !!f.match(qi) || e === "html" && -1 < f.indexOf("html");
          var h = f.indexOf(":host") === 0 && !g;
          c === "shady" && (g = f === e + " > *." + e || f.indexOf("html") !== -1, h = !g && f.indexOf(e) === 0);
          if (g || h)
            c = e, h && (b.F || (b.F = Xh(Qh, b, Qh.h, a ? "." + a : "", e)), c = b.F || e), g && e === "html" && (c = b.F || b.O), d({ Ba: c, ab: h, qb: g });
        }
      }
      function Ai(a, b, c) {
        var d = {}, e = {};
      ...
      function Bi(a, b, c, d) {
        var e = Jh(b), f = Wh(e.is, e.ha), g = new RegExp("(?:^|[^.#[:])" + (b.extends ? "\\" + f.slice(0, -1) + "\\]" : f) + "($|[.:[\\s>+~])"), h = ni(b);
        e = h.M;
        h = h.cssBuild;
        var k = Ci(e, d);
      ...
      var Fi = new si();
      var Gi = {}, Hi = window.customElements;
      if (Hi && !V && !oh) {
        var Ii = Hi.define;
          ...
          if (c.target !== document.documentElement && c.target !== document.head)
            for (var d = 0; d < c.addedNodes.length; d++) {
              ...
              if (e.nodeType === Node.ELEMENT_NODE) {
                var f = e.getRootNode(), g = Mi(e);
                if (g && f === e.ownerDocument && (e.localName !== "style" && e.localName !== "template" || Lh(e) === ""))
                  Th(e, g);
                else if (f instanceof ShadowRoot)
                  for (f = Ni(e), f !== g && Sh(e, g, f), e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + Qh.g + ")"), g = 0; g < e.length; g++) {
                    f = e[g];
                    var h = Ni(f);
                    h && Rh(f, h);
                  }
      ...
      if (!(V || window.ShadyDOM && window.ShadyDOM.handlesDynamicScoping)) {
        var Pi = new MutationObserver(Oi), Qi = function(a) {
          Pi.observe(a, { childList: true, subtree: true });
        };
      ...
      function Wi(a) {
        ...
        a._validating || (a._validating = true, Ti.then(function() {
      ...
      v.prepareTemplateStyles = function(a, b, c) {
        if (!a._prepared && !oh) {
          ...
          X || (g = ti(a._styleAst));
          if (!g.length || X)
            h = V ? a.content : null, b = Gi[b] || null, d = Uh(c, a._styleAst, null, d, e ? f : ""), d = d.length ? Ah(d, c.is, h, b) : null, a._style = d;
          a.g = g;
        }
      };
      v.fb = function(a, b) {
      ...
      v.prepareTemplateDom = function(a, b) {
        if (!oh) {
          var c = Lh(a);
          V || c === "shady" || a._domPrepared || (a._domPrepared = true, Oh(a.content, b));
        }
      };
      function $i(a) {
        var b = Jh(a), c = b.is;
        b = b.ha;
        var d = Gi[c] || null, e = Si[c];
        if (e) {
          c = e._styleAst;
          var f = e.g;
          e = Lh(e);
      ...
      v.styleElement = function(a, b) {
        if (oh) {
          ...
          if (a !== this.i && (this.O = true), b && (c.K = c.K || {}, Object.assign(c.K, b)), X)
            dj(this, a, c);
      ...
      v.styleSubtree = function(a, b) {
        var c = Ih(a), d = c.shadowRoot, e = a === this.i;
      ...
      (function(a) {
        ...
        function c(t) {
          ...
          return 32 < F && 127 > F && [34, 35, 60, 62, 63, 96].indexOf(F) == -1 ? t : encodeURIComponent(t);
        }
        function d(t) {
          var F = t.charCodeAt(0);
          return 32 < F && 127 > F && [34, 35, 60, 62, 96].indexOf(F) == -1 ? t : encodeURIComponent(t);
        }
        function e(t, F, E) {
          function M(fa) {
            sa.push(fa);
          }
          var y = F || "scheme start", W = 0, w = "", ta = false, ha = false, sa = [];
          a:
            for (; (t[W - 1] != void 0 || W == 0) && !this.m; ) {
              var n = t[W];
              switch (y) {
                case "scheme start":
                  if (n && q.test(n))
                ...
                case "scheme":
                  if (n && H.test(n))
                    ...
                    if (F)
                      break a;
                    l[this.l] !== void 0 && (this.G = true);
                    y = this.l == "file" ? "relative" : this.G && E && E.l == this.l ? "relative or authority" : this.G ? "authority first slash" : "scheme data";
                  } else if (F) {
                    n != void 0 && M("Code point not allowed in scheme: " + n);
                    break a;
                  } else {
                    w = "";
                    W = 0;
                  ...
                  break;
                case "scheme data":
                  n == "?" ? (this.A = "?", y = "query") : n == "#" ? (this.C = "#", y = "fragment") : n != void 0 && n != "	" && n != "\n" && n != "\r" && (this.va += c(n));
                  break;
                case "no scheme":
                  if (E && l[E.l] !== void 0) {
                    y = "relative";
                    ...
                    M("Missing scheme."), f.call(this), this.m = true;
                  break;
                ...
                case "relative":
                  ...
                  if (n == void 0) {
                    ...
                    y = t[W + 1];
                    var J = t[W + 2];
                    if (this.l != "file" || !q.test(n) || y != ":" && y != "|" || J != void 0 && J != "/" && J != "\\" && J != "?" && J != "#")
                ...
                case "relative slash":
                  if (n == "/" || n == "\\")
                    n == "\\" && M("\\ is an invalid code point."), y = this.l == "file" ? "file host" : "authority ignore slashes";
                  else {
                    this.l != "file" && (this.o = E.o, this.v = E.v, this.B = E.B, this.j = E.j);
                    y = "relative path";
                    continue;
                  }
                  break;
                ...
                case "authority":
                  if (n == "@") {
                    ...
                    for (n = 0; n < w.length; n++)
                      J = w[n], J == "	" || J == "\n" || J == "\r" ? M("Invalid whitespace in authority.") : J == ":" && this.j === null ? this.j = "" : (J = c(J), this.j !== null ? this.j += J : this.B += J);
                    w = "";
                  } else if (n == void 0 || n == "/" || n == "\\" || n == "?" || n == "#") {
                    W -= w.length;
                    w = "";
                    y = "host";
                    continue;
                ...
                case "file host":
                  if (n == void 0 || n == "/" || n == "\\" || n == "?" || n == "#") {
                    w.length != 2 || !q.test(w[0]) || w[1] != ":" && w[1] != "|" ? (w.length != 0 && (this.o = b.call(this, w), w = ""), y = "relative path start") : y = "relative path";
                    continue;
                  } else
                ...
                case "hostname":
                  if (n != ":" || ha)
                    if (n == void 0 || n == "/" || n == "\\" || n == "?" || n == "#") {
                      ...
                      n != "	" && n != "\n" && n != "\r" ? (n == "[" ? ha = true : n == "]" && (ha = false), w += n) : M("Invalid code point in host/hostname: " + n);
                  else if (this.o = b.call(this, w), w = "", y = "port", F == "hostname")
                    break a;
                  break;
                case "port":
                  if (/[0-9]/.test(n))
                    w += n;
                  else if (n == void 0 || n == "/" || n == "\\" || n == "?" || n == "#" || F) {
                    ...
                    n == "	" || n == "\n" || n == "\r" ? M("Invalid code point in port: " + n) : (f.call(this), this.m = true);
                  break;
                case "relative path start":
                  ...
                  break;
                case "relative path":
                  if (n != void 0 && n != "/" && n != "\\" && (F || n != "?" && n != "#"))
                    n != "	" && n != "\n" && n != "\r" && (w += c(n));
                  else {
                    n == "\\" && M("\\ not allowed in relative path.");
                    if (J = m[w.toLowerCase()])
                      w = J;
                    w == ".." ? (this.s.pop(), n != "/" && n != "\\" && this.s.push("")) : w == "." && n != "/" && n != "\\" ? this.s.push("") : w != "." && (this.l == "file" && this.s.length == 0 && w.length == 2 && q.test(w[0]) && w[1] == "|" && (w = w[0] + ":"), this.s.push(w));
                    w = "";
                    n == "?" ? (this.A = "?", y = "query") : n == "#" && (this.C = "#", y = "fragment");
                  }
                  break;
                case "query":
                  F || n != "#" ? n != void 0 && n != "	" && n != "\n" && n != "\r" && (this.A += d(n)) : (this.C = "#", y = "fragment");
                  break;
                case "fragment":
                  n != void 0 && n != "	" && n != "\n" && n != "\r" && (this.C += n);
              }
        ...
        function g(t, F) {
          F === void 0 || F instanceof g || (F = new g(String(F)));
          this.g = t;
          f.call(this);
      ...
      document.readyState !== "complete" ? (window.addEventListener("load", kj), window.addEventListener("DOMContentLoaded", function() {
...
// dep:@webcomponents_webcomponentsjs
var webcomponents_webcomponentsjs_default = require_webcomponents_bundle();
export {
  webcomponents_webcomponentsjs_default as default
};
/**
@license @nocompile
...
*/
//# sourceMappingURL=@webcomponents_webcomponentsjs.js.map
